(function () {
    ...
    function renderProduct(product, detail) {
        ...
        var pdfResourceItem = resourceItem('picture_as_pdf', '产品PDF下载', datasheet ? '产品规格书' : '暂无 PDF', datasheet || '#', !!datasheet);
